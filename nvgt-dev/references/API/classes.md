...
class string {
	...
	string(float);
	string(bool);
	string(const ?&in, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null, const ?&in = null);
	...
	string lowercase(const string&inout) const;
	string uppercase(const string&inout) const;
	string titlecase() const;
	string titlecase(const string&inout) const;
	int compare(const string&inout, const bool) const;
	int collate(const string&inout, const bool) const;
	bool is_valid_unicode() const;
	string to_nfc() const;
	string to_nfd() const;
	string to_nfkc() const;
	string to_nfkd() const;
	string to_unaccented() const;
	bool is_nfc() const;
	bool is_nfd() const;
	bool is_nfkc() const;
	bool is_nfkd() const;
	unicode::general_category general_category() const;
	bool is_alphabetic() const;
	bool is_numeric() const;
	bool is_alphanumeric() const;
	bool is_whitespace() const;
	bool is_reserved() const;
	bool is_valid_char() const;
	bool is_valid_scalar() const;
	bool is_supplementary() const;
	bool is_noncharacter() const;
	bool is_surrogate() const;
	bool is_private_use() const;
	bool is_control() const;
	string get_script() const;
	bool has_script(const string&inout) const;
	array<uint64>@ find(const string&inout, const bool) const;
}
...
class memory_reader {
	...
	memory_reader();
	memory_reader(uint64, uint64, const string&in encoding = \\, int byteorder = 1);
...
class line_converting_writer {
	bool binary;
	bool sync_rw_cursors;
	line_converting_writer();
	line_converting_writer(datastream@, const string&in line_ending = spec::NEWLINE_DEFAULT, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class base64_encoder {
	...
	bool sync_rw_cursors;
	base64_encoder();
	base64_encoder(datastream@, int options = 0, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class calendar {
	calendar();
	calendar(double julian_day);
	calendar(int year, int month, int day, int hour = 0, int minute = 0, int second = 0, int millisecond = 0, int microsecond = 0);
	calendar(const datetime&in);
	calendar(const calendar&in);
...
class inflating_writer {
	bool binary;
	bool sync_rw_cursors;
	inflating_writer();
	inflating_writer(datastream@, compression_method compression = COMPRESSION_METHOD_ZLIB, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class counting_writer {
	bool binary;
	bool sync_rw_cursors;
	counting_writer();
	counting_writer(datastream@, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class counting_reader {
	bool binary;
	bool sync_rw_cursors;
	counting_reader();
	counting_reader(datastream@, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class text_font {
	text_font(const string&in name, float size, uint style = FONT_STYLE_NORMAL);
...
class duplicating_reader {
	...
	bool sync_rw_cursors;
	duplicating_reader();
	duplicating_reader(datastream@, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class line_converting_reader {
	bool binary;
	bool sync_rw_cursors;
	line_converting_reader();
	line_converting_reader(datastream@, const string&in line_ending = spec::NEWLINE_DEFAULT, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class datastream {
	bool binary;
	bool sync_rw_cursors;
	datastream(const string&in = \\);
	datastream(const string&in initial_data, const string&in encoding, int byteorder = STREAM_BYTE_ORDER_NATIVE);
	datastream@ opCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class file {
	...
	bool sync_rw_cursors;
	file();
	file(const string&in, const string&in, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class hex_decoder {
	...
	bool sync_rw_cursors;
	hex_decoder();
	hex_decoder(datastream@, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class duplicating_writer {
	bool binary;
	bool sync_rw_cursors;
	duplicating_writer(const string&in encoding = \\, int byteorder = 1);
	duplicating_writer(datastream@, const string&in = \\, int byteorder = 1);
...
class hex_encoder {
	...
	bool sync_rw_cursors;
	hex_encoder();
	hex_encoder(datastream@, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class audio_freeverb_node {
	audio_freeverb_node(audio_engine@ engine = sound_default_engine);
...
class base32_decoder {
	...
	bool sync_rw_cursors;
	base32_decoder();
	base32_decoder(datastream@, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class base32_encoder {
	bool binary;
	bool sync_rw_cursors;
	base32_encoder();
	base32_encoder(datastream@, bool padding = true, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class base64_decoder {
	...
	bool sync_rw_cursors;
	base64_decoder();
	base64_decoder(datastream@, int options = 0, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class random_reader {
	bool binary;
	bool sync_rw_cursors;
	random_reader(const string&in encoding = \\, int byteorder = 1);
	bool open(const string&in encoding = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
...
class discarding_writer {
	bool binary;
	bool sync_rw_cursors;
	discarding_writer(const string&in encoding = \\, int byteorder = 1);
	bool open(const string&in encoding = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
...
class deflating_reader {
	bool binary;
	bool sync_rw_cursors;
	deflating_reader();
	deflating_reader(datastream@, compression_method compression = COMPRESSION_METHOD_ZLIB, int level = 9, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class deflating_writer {
	bool binary;
	bool sync_rw_cursors;
	deflating_writer();
	deflating_writer(datastream@, compression_method compression = COMPRESSION_METHOD_ZLIB, int level = 9, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class inflating_reader {
	bool binary;
	bool sync_rw_cursors;
	inflating_reader();
	inflating_reader(datastream@, compression_method compression = COMPRESSION_METHOD_ZLIB, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class asset_encryptor {
	bool binary;
	bool sync_rw_cursors;
	asset_encryptor();
	asset_encryptor(datastream@, string&in key, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class asset_decryptor {
	bool binary;
	bool sync_rw_cursors;
	asset_decryptor();
	asset_decryptor(datastream@, const string&in key, const string&in = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class memory_writer {
	...
	bool sync_rw_cursors;
	memory_writer();
	memory_writer(uint64, uint64, const string&in encoding = \\, int byteorder = 1);
	datastream@ opImplCast();
	bool close(bool = false);
	bool close_all();
	bool get_active() const property;
...
class internet_request {
	...
	internet_request();
	internet_request(const string&in, bool = true);
	internet_request(const string&in, const string&in, bool = true);
	internet_request(const string&in, const string&in, const string&in, bool = true);
	bool perform();
	bool perform(const string&in);
	bool post(const string&in, const string&in, const string&in = '');
	bool mail(const string&in, const string&in, const string&in, const string&in) const;
	void set_url(const string&in) const;
	void set_path(const string&in) const;
	void set_authentication(string, string);
	void set_payload(const string&in) const;
	void set_mail(const string&in, const string&in) const;
	void set_header(const string&in, const string&in) const;
	void reset() const;
}
class var {
	var();
	...
	var(const bool&in);
	var(const string&in);
	var(const json_object&in);
	var(const json_array&in);
...
class web_socket {
	web_socket(const socket&in sock);
	web_socket(const web_socket&in sock);
	web_socket(http_client&inout cs, http_request&inout request, http_response&inout response);
	web_socket(http_client&inout cs, http_request&inout request, http_response&inout response, http_credentials&inout credentials);
...
class path {
	path();
	path(bool);
	path(const string&in);
	path(const string&in, spec::path_style);
	path(const spec::path&in);
	path(const spec::path&in, const string&in);
	path(const spec::path&in, const spec::path&in);
	...
	spec::path opDiv(const spec::path&in) const;
	spec::path opDiv(const string&in) const;
	string opImplConv() const;
...
class uri {
	uri();
	uri(const string&in uri);
	uri(const string&in scheme, const string&in path_etc);
	uri(const string&in scheme, const string&in authority, const string&in path_etc);
	uri(const string&in scheme, const string&in authority, const string&in path, const string&in query);
	uri(const string&in scheme, const string&in authority, const string&in path, const string&in query, const string&in fragment);
	uri(const spec::uri&in base_uri, const string&in relative_uri);
	uri(const spec::path&in path);
	uri(const spec::uri&in);
...
class stream_socket {
	stream_socket();
	stream_socket(const socket&in sock);
	stream_socket(const stream_socket&in sock);
	stream_socket(const socket_address&in address);
	stream_socket(const spec::ip_address_family);
...
class audio_engine {
	audio_engine(int flags, int sample_rate = 0, int channels = 0);
	uint get_input_bus_count() const property;
	uint get_output_bus_count() const property;
	uint get_input_channels(uint bus) const;
	uint get_output_channels(uint bus) const;
...
class audio_node_chain {
	audio_node_chain(audio_node@ source = null, audio_node@ endpoint = null, audio_engine@ engine = sound_default_engine);
	uint get_input_bus_count() const property;
	uint get_output_bus_count() const property;
	uint get_input_channels(uint bus) const;
	uint get_output_channels(uint bus) const;
...
class audio_decoder {
	audio_decoder(audio_engine@ engine = sound_default_engine);
	uint get_input_bus_count() const property;
	uint get_output_bus_count() const property;
	uint get_input_channels(uint bus) const;
	uint get_output_channels(uint bus) const;
...
class audio_ring_buffer {
	audio_ring_buffer(uint channels, uint size, audio_engine@ engine = sound_default_engine);
	uint get_input_bus_count() const property;
	uint get_output_bus_count() const property;
	uint get_input_channels(uint bus) const;
	uint get_output_channels(uint bus) const;
...
class audio_opus_encoder {
	audio_opus_encoder(audio_engine@ engine = sound_default_engine);
	uint get_input_bus_count() const property;
	uint get_output_bus_count() const property;
	uint get_input_channels(uint bus) const;
	uint get_output_channels(uint bus) const;
...
class datetime {
	datetime();
	datetime(const timestamp&in timestamp);
	datetime(double julian_day);
...
class http_response {
	http_response();
	http_response(const http_response&in);
	http_response(http_status);
	http_response(http_status, const string&in);
	http_response(const string&in, http_status, const string&in);
	http_response(const string&in, http_status);
...
class http_request {
	http_request();
	http_request(const http_request&in);
	http_request(const string&in, const string&in, const string&in = HTTP_1_1);
...
class game_window {
	game_window(const string&in title, uint w, uint h, uint flags = 0);
	bool show();
	bool hide();
	bool raise();
	bool maximize();
	...
	void draw_menu(array<string>@ items, float x, float y);
